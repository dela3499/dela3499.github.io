...
Can you study a song's structure without ever hearing it? Indeed you can. By using different methods to visualize the audio in a song, one can see not only which sections are quiet or loud, but also differentiate between the sonic textures in different sections.
